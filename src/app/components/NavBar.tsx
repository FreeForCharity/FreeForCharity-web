    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-b border-black/10">
      <div className="ffc-container h-[92px] flex items-center justify-between">
        ...
        <a href="/" className="flex items-center gap-3" aria-label="Free For Charity home">
          <div className="w-[70px] h-[46px] bg-[url('/Free For Charity (cover Photo).png')] bg-contain bg-left bg-no-repeat" aria-hidden />
        ...
        <nav className="hidden md:flex items-center gap-6 text-black">
          <a className="font-[var(--font-fauna-one)] text-[15px] leading-[18px]" href="/">Home</a>

          <div className="flex items-center gap-1">
            <a className="font-[var(--font-fauna-one)] text-[15px] leading-[18px]" href="#">Help for Charities</a>
            <ChevronDown />
          </div>

          <a className="font-[var(--font-fauna-one)] text-[15px] leading-[18px]" href="#">Volunteer</a>
          <a className="font-[var(--font-fauna-one)] text-[15px] leading-[18px]" href="#">Donate</a>

          <div className="flex items-center gap-1">
            <a className="font-[var(--font-fauna-one)] text-[15px] leading-[18px]" href="#">About Us</a>
            <ChevronDown />
          </div>

          <div className="flex items-center gap-1">
            <a className="font-[var(--font-fauna-one)] text-[15px] leading-[18px]" href="#">Other</a>
            <ChevronDown />
          </div>
        </nav>
        ...
        <div className="md:hidden flex items-center gap-3">
          <a href="#" className="rounded-[27px] bg-primary text-white px-4 py-2 text-sm font-[var(--font-lato)]">Donate</a>
